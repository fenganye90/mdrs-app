package com.winning.mdrs.config;
...
@MapperScan(basePackages = "com.winning.mdrs.perimissionmag", sqlSessionTemplateRef  = "testSqlSessionTemplate")
public class DataSourceConfig {
	...
	public SqlSessionFactory testSqlSessionFactory(@Qualifier("testDataSource") DataSource dataSource) throws Exception {
		...
		bean.setTypeAliasesPackage("com.winning.mdrs.perimissionmag.model");
		//对应mybatis.mapper-locations配置
		bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/permissionmapper/*.xml"));
		//开启驼峰映射
